...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_LOG_OP_BIN = 14,                /* LOG_OP_BIN  */
  YYSYMBOL_REL_OP_BAIXA = 15,              /* REL_OP_BAIXA  */
  YYSYMBOL_REL_OP_ALTA = 16,               /* REL_OP_ALTA  */
  YYSYMBOL_LIST_OP = 17,                   /* LIST_OP  */
  YYSYMBOL_ARIT_OP_BAIXA = 18,             /* ARIT_OP_BAIXA  */
  YYSYMBOL_ARIT_OP_ALTA = 19,              /* ARIT_OP_ALTA  */
  YYSYMBOL_LOG_OP_UN = 20,                 /* LOG_OP_UN  */
  YYSYMBOL_CONST = 21,                     /* CONST  */
  YYSYMBOL_STRING = 22,                    /* STRING  */
  YYSYMBOL_NIL = 23,                       /* NIL  */
  YYSYMBOL_ID = 24,                        /* ID  */
  YYSYMBOL_ABRE_P = 25,                    /* ABRE_P  */
  YYSYMBOL_FECHA_P = 26,                   /* FECHA_P  */
  YYSYMBOL_PV = 27,                        /* PV  */
  YYSYMBOL_YYACCEPT = 28,                  /* $accept  */
  YYSYMBOL_teste = 29                      /* teste  */
};
...
static const char *const yytname[] =
{
  ...
  "IF", "ELSE", "FOR", "RETURN", "ENTRADA", "SAIDA", "TIPO", "VIRG",
  "ATRIB", "LOG_OP_BIN", "REL_OP_BAIXA", "REL_OP_ALTA", "LIST_OP",
  "ARIT_OP_BAIXA", "ARIT_OP_ALTA", "LOG_OP_UN", "CONST", "STRING", "NIL",
  "ID", "ABRE_P", "FECHA_P", "PV", "$accept", "teste", YY_NULLPTR
};
